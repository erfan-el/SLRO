...
>
> 💡 **Tip:** Java is required to run Protégé. If you don’t have Java installed, the website provides bundled versions with Java included.
...
![Opening ontology in Protégé](Protégé Tutorial/1. open-ontology-file.png)
...
![Browsing classes in Protégé](IMAGE2)
...
- Below that, in the **Description** section, you will find important metadata and structural information about the selected class.
...
- Below that, the **Description** section displays useful details about the selected property.

![Object properties in Protégé](Image 3)
...
![Viewing individuals in Protégé](Image4)
...
![Starting the reasoner in Protégé](Image 5)
...
![DL Query tab in Protégé](Image 6)
...
![SPARQL query tab in Protégé](Image 7)
